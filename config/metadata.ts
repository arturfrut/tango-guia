...
export const pagesMetadata: Record<string, Metadata> = {
  ...
  semillero: {
    ...
    twitter: {
      ...
      title: 'El Semillero - Jóvenes y Tango en Mar del Plata',
      description:
        'Clases y beneficios para jóvenes de 18 a 35 años que quieran vivir el tango.',
  ...
  sobreTango: {
    ...
    twitter: {
      ...
      title: 'Sobre Tango Guía',
      description:
        'Un proyecto para conectar y potenciar la comunidad tanguera de Mar del Plata.',
  ...
  recomendaciones: {
    ...
    twitter: {
      ...
      title: 'Recomendaciones y Denuncias',
      description:
        'Enviá tus sugerencias o denuncias para mejorar el tango en Mar del Plata.',
  ...
  agenda: {
    ...
    openGraph: {
      ...
      description:
        'Agenda actualizada con todas las clases y milongas en Mar del Plata.',
