  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-start">
      ...
      <div className="max-w-3xl text-default-700 px-4 space-y-4 mb-10 text-center">
        ...
        <p>
          Las clases están a cargo de <strong>Melanie Salinas</strong>, una de las profesoras y
          bailarinas más importantes de la ciudad. Si este lugar no te queda cómodo o no te da el
          horario, podés ir a cualquiera de los otros espacios participantes. ¡Lo importante es
          sumarse!
        </p>
        <p>
