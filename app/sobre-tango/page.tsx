    ...
    <section className='min-h-screen flex flex-col items-center justify-start pb-10'>
      ...
      <div className='text-center max-w-3xl px-4 mb-8'>
        ...
        <p className='text-lg text-default-500'>
          Tango Guía es un proyecto que busca fortalecer el ecosistema tanguero
          de Mar del Plata, combinando una aplicación web con buen SEO y un
          chatbot de WhatsApp para facilitar la difusión de clases, milongas y
          eventos. Nuestro objetivo es que tanto quienes están dentro de la
          comunidad como quienes no, tengan acceso a la información de forma
          clara, sencilla y centralizada.
        </p>
      </div>
      ...
      <div className='max-w-3xl text-default-700 px-4 space-y-4 mb-10'>
        <p>
          Nacimos para resolver dos grandes problemáticas: la dificultad para
          enterarse de lo que pasa en el ambiente, y la falta de participación
          de gente joven.
        </p>
        <p>
          Con herramientas simples, buscamos que cualquier docente pueda subir
          sus eventos y que cualquier persona pueda encontrar dónde y cuándo
          bailar tango. Además, impulsamos
          <strong> "El Semillero"</strong>, un espacio de formación para nuevas
          generaciones.
        </p>
      ...
      <div className='max-w-3xl px-4 mb-10'>
        ...
        <p className='mb-4'>
          Si no podés colaborar económicamente, también necesitamos:
        </p>
