    ...
    <section className="min-h-screen flex flex-col items-center justify-start py-10">
      ...
      <div className="text-center max-w-3xl px-4 mb-8">
        ...
        <p className="text-lg text-default-500">
          Esta sección está pensada para <strong>mejorar el tango en Mar del Plata</strong>. 
          Si sufriste alguna incomodidad o situación que creas importante avisar, o si tenés 
          alguna recomendación para que podamos mejorar, este es el lugar.
        </p>
      </div>
      ...
      <div className="max-w-3xl text-default-700 px-4 space-y-4 mb-10">
        ...
        <p>
          El objetivo es <strong>mejorar los espacios</strong>, la convivencia y la experiencia 
          de todas las personas que forman parte de la comunidad tanguera.
        </p>
        <p>
